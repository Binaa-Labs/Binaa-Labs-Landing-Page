...
Last updated: 2026-07-19 · Status: **Push-prep complete (`d888d75` pushed); owner preview review completed and approved on the `feat/site-redesign` preview; binding Lighthouse measurement done (mobile LCP 3.3s vs. 2.5s budget) → D19 disables the splash on mobile; next measurement (LCP 3.4s, `h1.hero-title`) traced to a second JS-gated hider → D19 rung 2b makes mobile hero copy paint from CSS alone, re-measure pending; refinement pass 2 (D20, hero mock variation + FAQ fit question) landed**
